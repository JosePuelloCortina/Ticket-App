            ...
            <div>
              ...
              >
                <textarea
                  ...
                  onChange={(e) =>
                    setInput({ ...input, commentary: e.target.value })
                  }
                ></textarea>
                <div style={{ marginBottom: 20 }} className="btn-group col-3">
                  {/*agrupa los botones*/}
                  ...
                  <input
                    ...
                    required={true}
                    onChange={(e) =>
                      setInput({ ...input, calification: e.target.value })
                    }
                  />
                </div>
                    ...
                    <div key={re.user}>
                      ...
                      <div className="review-colomn">
                        <span className="be-comment-name">
                          <h5 href="blog-detail-2.html">
                            Nombre de usuario:{" "}
                            {re.nombre ? re.nombre : "Juana 123"}
                          </h5>
                        </span>
                        <div>
                          <h6>
